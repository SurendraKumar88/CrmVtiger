...
public class ContactTest extends BaseClass{
	...
	public void createContactTest() throws Throwable{
		...
		String contactName=comUtils.getExcelData("testData", 1, 2);
		...
		comUtils.setExcelData("testData", 1, 13, "Pass");
	}
	...
	public void createContactWithImageTest() throws Throwable{
		...
		Reporter.log("read test data from excel",true);
		String contactName=comUtils.getExcelData("testData", 3, 2);
		String imagePath=comUtils.getExcelData("testData", 3, 7);
		...
		comUtils.setExcelData("testData", 3, 13, "Pass");
		sAssert.assertAll();
	}
	...
	public void createContactWithOrganizationTest() throws Throwable{
		...
		Reporter.log("read test data from excel",true);
		String contactName=comUtils.getExcelData("testData", 2, 2);
		String organizationName=comUtils.getExcelData("testData", 2, 3)+ran.nextInt();
		...
		comUtils.setExcelData("testData", 2, 13, "Pass");
		sAssert.assertAll();
	}
