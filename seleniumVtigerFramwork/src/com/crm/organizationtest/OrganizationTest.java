...
public class OrganizationTest extends BaseClass{
	...
	public void createOrganizationTest() throws Throwable{
		...
		String organizationName=comUtils.getExcelData("testData", 4, 3)+ran.nextInt();
		...
		comUtils.setExcelData("testData", 4, 13, "Pass");
	}
	...
	public void createOrganizationWithOrganizationTypeTest() throws Throwable{
		...
		Reporter.log("read test data from excel",true);
		String organizationName=comUtils.getExcelData("testData", 5, 3)+ran.nextInt();
		String orgType=comUtils.getExcelData("testData", 5, 4);
		...
		comUtils.setExcelData("testData", 5, 13, "Pass");
		sAssert.assertAll();
	}
