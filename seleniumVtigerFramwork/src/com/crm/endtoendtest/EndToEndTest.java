...
public class EndToEndTest extends BaseClass{
	...
	public void createOpertunityUsingOrgCompaignTest() throws Throwable{
		...
		String organizationName=comUtils.getExcelData("testData", 6, 3)+ran.nextInt();
		String campaignName=comUtils.getExcelData("testData", 6, 5);
		String oppertunityName=comUtils.getExcelData("testData", 6, 6);
	...
	public void deleteOrgWhenOrgContainsContact_OpertunityTest() throws Throwable{
		...
		Reporter.log("read test data from excel",true);
		String organizationName=comUtils.getExcelData("testData", 7, 3)+ran.nextInt();
		String contactName=comUtils.getExcelData("testData", 7, 2);
		String oppertunityName=comUtils.getExcelData("testData", 7, 6);
